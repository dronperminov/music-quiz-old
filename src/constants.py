...
QUESTION_YEARS = [1950, 1980, 1990, 2000, 2010, 2015, 2020]
...
ARTIST_FORMS = {
    "default": ["исполнитель", "исполнителя"],
    "group": ["группа", "группу"],
    "singer_man": ["певец", "певца"],
    "singer_woman": ["певица", "певицу"],
    "artist_man": ["исполнитель", "исполнителя"],
    "artist_woman": ["исполнительница", "исполнительницу"],
    "musician": ["музыкант", "исполнителя"],
    "project": ["проект", "проект"],
    "duet": ["дуэт", "дуэт"],
    "trio": ["трио", "трио"],
    "dj": ["диджей", "диджея"],
    "via": ["ВИА", "ВИА"],
    "composer": ["композитор", "исполнителя"]
}
